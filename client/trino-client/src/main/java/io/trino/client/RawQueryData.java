 ...
 * It has custom handling and representation in the QueryDataJacksonModule.
 */
        ...
        implements QueryData
{
    ...
    // JSON encoded looses type information. In order for it to be usable, we need to fix types
