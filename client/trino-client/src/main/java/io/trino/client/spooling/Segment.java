...
public abstract class Segment
{
    ...
    {
        return getRequiredAttribute(BYTE_SIZE, Integer.class);
    }
    ...
    public static Segment spooled(URI segmentUri, DataAttributes attributes)
    {
        return new SpooledSegment(segmentUri, attributes);
    }
}
