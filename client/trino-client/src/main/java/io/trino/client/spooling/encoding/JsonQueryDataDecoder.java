...
{
    public static final String ENCODING_ID = "json-ext";
    ...
    @Override
    public @Nullable Iterable<List<Object>> decode(InputStream stream, DataAttributes attributes)
    {
        if (stream == null) {
            return null;
        }
            ...
            extends Factory
    {
        ...
        public QueryDataDecoder create(List<Column> columns, DataAttributes queryAttributes)
        {
            return new SnappyQueryDataDecoder(super.create(columns, queryAttributes));
        }
