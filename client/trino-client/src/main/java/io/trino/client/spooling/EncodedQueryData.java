        ...
        implements QueryData
{
    ...
    @JsonCreator
    public EncodedQueryData(@JsonProperty("encodingId") String encodingId, @JsonProperty("metadata") Map<String, Object> metadata, @JsonProperty("segments") List<Segment> segments)
    {
