...
public enum DataAttribute
{
    ...
    BYTE_SIZE("byteSize", Integer.class),
    ...
    // Symmetric encryption key used to decrypt the segment, added only to encrypted segments
    ENCRYPTION_KEY("encryptionKey", String.class),
    // Encryption cipher name, added only to encrypted segments
    ENCRYPTION_CIPHER_NAME("cipherName", String.class);
