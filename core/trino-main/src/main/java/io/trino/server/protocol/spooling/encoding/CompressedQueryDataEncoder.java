        ...
        implements QueryDataEncoder
{
            ...
            throws IOException
    {
        ...
        int uncompressedSize = attributes.get(BYTE_SIZE, Integer.class);
        ...
        return attributes
                .toBuilder()
                .set(BYTE_SIZE, compress(buffer.toByteArray(), uncompressedSize, output)) // actual size of compressed data
