...
public class SnappyQueryDataEncoder
        extends CompressedQueryDataEncoder
{
    private static final int COMPRESSION_THRESHOLD = 2_048;

    public SnappyQueryDataEncoder(QueryDataEncoder delegate)
    {
    ...
    {
        return delegate.encodingId() + "+snappy";
    }
}
