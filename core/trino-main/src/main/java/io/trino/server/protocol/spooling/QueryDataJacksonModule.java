        ...
        extends SimpleModule
{
            ...
            extends StdSerializer<Segment>
    {
        ...
        public void serialize(Segment value, JsonGenerator gen, SerializerProvider provider)
                throws IOException
        {
            createSerializer(provider, provider.constructSpecializedType(provider.constructType(Segment.class), value.getClass())).serializeWithType(value, gen, provider, segmentSerializer(provider));
        }
