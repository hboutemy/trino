...
/**
 * Delta Lake connector smoke test exercising Hive metastore and MinIO storage with exclusive create support
 */
public class TestDeltaLakeMinioWithExclusiveWritesAndHmsConnectorSmokeTest
