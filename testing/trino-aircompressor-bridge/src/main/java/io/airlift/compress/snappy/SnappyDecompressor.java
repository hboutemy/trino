        ...
        implements Decompressor
{
    ...
    {
        this.decompressor = io.airlift.compress.v2.snappy.SnappyDecompressor.create();
    }
    ...
    {
        return io.airlift.compress.v2.snappy.SnappyDecompressor.create().getUncompressedLength(input, offset);
    }
}
